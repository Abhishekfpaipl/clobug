        ...
        <div class="justify-content-between mb-2 d-none d-md-flex">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="#" @click="sortByPrice('high')">Sort by Price (High to Low)</a></li>
                    <li><a class="dropdown-item" href="#" @click="sortByPrice('low')">Sort by Price (Low to High)</a></li>
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-3 border border-1" v-show="showFilterPanel">
                <div class="d-flex justify-content-between mt-3">
                    <p class=" fs-4  mb-0 text-start">Category</p>
                ...
                <div class="accordion-header">
                    <div class="d-flex flex-wrap">
                        <div v-for="(category, index) in categoriesD" :key="index">
                            <div v-if="index < count">
                                <input type="checkbox" class="btn-check p-0" name="style" :id="'name' + index"
                                    autocomplete="off">
                                <label class="btn btn-outline-dark rounded-0 m-2" :for="'name' + index">{{ category.name
                                }}</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col " v-for="(product, index) in products" :key="index">
                        <div class="card rounded-0 show-on-hover">
                            ...
                            <div class="card-footer p-0">
                                <div class="btn-group w-100 rounded-bottom overflow-hidden">
...
import CatalogFilter from '@/components/Catelog/CatalogFilter.vue';
