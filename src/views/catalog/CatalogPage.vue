...
import PatternFilter from '@/components/filters/PatternFilter.vue';
import LengthFilter from '@/components/filters/LengthFilter.vue';
import StyleFilter from '@/components/filters/StyleFilter.vue';
export default {
    name: "CatelogPage",
